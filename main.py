...
# Tariffs
tariffs = pd.read_csv('Ht_nt_times.csv', sep=',')
...
# Chargers data
df_mfh = pd.read_csv('charging_data.csv')
df_mfh["chargerType"] = "MFH"
df_work = pd.read_csv(r'.\Work\charging_data.csv')
df_work["chargerType"] = "Work"
df_poi = pd.read_csv(r'.\POI\charging_data.csv')
...
# to csv
df_chargers.to_csv("cleaned_data.csv", index=False)